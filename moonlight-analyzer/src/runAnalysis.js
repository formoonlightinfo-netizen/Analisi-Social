...
export async function runAnalysis(id, framesDir) {
  // Le variabili CLAUDE_CODE_SESSION_ID / CLAUDE_CODE_REMOTE_SESSION_ID legano
  // il processo alla sessione interattiva corrente: vanno rimosse per far
  // partire una sessione headless indipendente e leggera.
